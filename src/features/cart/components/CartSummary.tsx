    ...
    <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm space-y-6">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="flex justify-between items-center pt-2">
          <span className="text-lg font-bold text-[#1d2433]">Grant Total</span>
      ...
      <div className="pt-4">
        <Button className="w-full h-14 bg-[#1d2433] hover:bg-[#2d3648] text-white text-lg font-bold rounded-xl transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3">
          Proceed to Checkout
          <ArrowRight size={20} />
        </Button>
      </div>
